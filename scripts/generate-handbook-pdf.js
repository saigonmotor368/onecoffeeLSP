...
<body>
  ...
  <div class="card">
    <div class="card-title">
      <span>💳 3. ĐẶT HÀNG & THANH TOÁN TIỆN LỢI</span>
    </div>

    <div class="step-desc" style="margin-bottom: 10px;">
      Tại trang <strong>Thanh toán (Checkout)</strong>, quý khách chỉ cần nhập thông tin một lần, hệ thống sẽ tự động ghi nhớ cho các lần đặt tiếp theo:
    </div>

    <div class="step-grid">
      <div class="step-box">
        <div class="step-heading">Thông tin người nhận & Địa chỉ</div>
        <div class="step-desc">
          - Nhập <strong>Họ tên & Số điện thoại</strong> nhận hàng.<br>
          - Nhập <strong>Khu vực giao hàng</strong> trong nhà máy LSP (chọn hoặc gõ số xưởng, phòng ban, cổng kiểm soát).<br>
          - <em>Tài khoản được tự động kích hoạt bảo mật theo SĐT của bạn!</em>
        </div>
      </div>

      <div class="step-box">
        <div class="step-heading">Hình thức thanh toán linh hoạt</div>
        <div class="step-desc">
          - <strong>Chuyển khoản VietQR:</strong> Quét mã QR bằng App ngân hàng (MB, Vietcombank, Techcombank, MoMo...), mã tự điền chính xác số tiền và số đơn hàng.<br>
          - <strong>Tiền mặt (COD):</strong> Thanh toán trực tiếp cho shipper khi nhận nước tận tay.
        </div>
      </div>
    </div>

    <div class="highlight-box">
      🎁 <strong>Ưu đãi nhân viên & Voucher:</strong> Hãy nhập mã giảm giá (nếu có) tại ô <em>"Mã giảm giá / Voucher"</em>. Nếu là nhân viên LSP, bạn còn được hưởng chính sách giá và freeship theo chương trình của quán!
    </div>
  </div>
  ...
  <div class="card">
    <div class="card-title">
      <span>🛵 4. THEO DÕI TRẠNG THÁI ĐƠN HÀNG THỜI GIAN THỰC</span>
    </div>
    <p style="font-size: 12px; color: #475569; margin-bottom: 8px;">
      Sau khi đặt đơn, bạn có thể theo dõi trực tiếp trạng thái ly nước của mình thay đổi trên màn hình:
    </p>
